...
if __name__=="__main__":
    df = pd.read_parquet("/scratch/venia/web2wiki/data/test/santized-er_wiki.parquet")
    ...
    df2 = df[df["order"]==1]
    df2.loc[(df2["order"]==1) & (df2["attribution"] == "attribution"),"first_class"] = "attribution"
    df2.loc[(df2["order"]==1) & (df2["evidence"] == "evidence"),"first_class"] = "evidence"
    df2["first_class"] = df2["first_class"].fillna("ws")
    ...
    df2.to_csv("/scratch/venia/web2wiki/data/validation/first_order.csv")